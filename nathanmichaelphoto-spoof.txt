nathanmichaelphoto-spoof.js application/javascript
(function() {
    ...
    addEntry(location.href.replace(/[?#].*/, '').replace(/\/?$/, '/') + 'z3993', 'img');
})();
